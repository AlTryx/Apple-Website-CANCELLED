...
const VideoCarousel = () => {
  ...
  useEffect(() => {
    if(loadedData.length>3){
        if(!isPlaying){
            videoRef.current[videoId].pause(); // ako sme otishli do kraq and we're no longer playing (animation) then PAUSE.
        } else {
  ...
  return (
    ...
    <div className = "relative flex-center mt-10">
        ...
        <button className = "control-btn">
            <img
            src = {isLastVideo ? replayImg: !isPlaying ? playImg: pauseImg}// if isLastVideo ? then replayImg else if isPlaying = false THEN playImg render pauseImg
